...
for i in range(1,11):
    ...
    printf(f"Bei der Verwendung des Wert {i} erreichen wir eine Genauigkeit von {accuracy_score(predictions, y_test)*100}%.")
...
printf(f"Der höchste Genauigkeitswert der erreicht wurde liegt bei {hoechster_genauigkeitswert[1]}%, bei der betrachtung von {hoechster_genauigkeitswert[0]} Nachbarn.")